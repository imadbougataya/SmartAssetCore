...
public class AssetAsserts {
    ...
    public static void assertAssetUpdatableFieldsEquals(Asset expected, Asset actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getGeofencePolicy()).as("check geofencePolicy").isEqualTo(expected.getGeofencePolicy()))
    ...
    public static void assertAssetUpdatableRelationshipsEquals(Asset expected, Asset actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getAllowedSite()).as("check allowedSite").isEqualTo(expected.getAllowedSite()))
            .satisfies(a -> assertThat(a.getAllowedZone()).as("check allowedZone").isEqualTo(expected.getAllowedZone()));
    }
}
