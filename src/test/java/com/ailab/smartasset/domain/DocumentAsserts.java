...
public class DocumentAsserts {
    ...
    public static void assertDocumentUpdatableFieldsEquals(Document expected, Document actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStorageRef()).as("check storageRef").isEqualTo(expected.getStorageRef()))
            .satisfies(a -> assertThat(a.getChecksumSha256()).as("check checksumSha256").isEqualTo(expected.getChecksumSha256()))
