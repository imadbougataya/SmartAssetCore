...
public class LocationEventTestSamples {
    ...
    public static LocationEvent getLocationEventSample1() {
        return new LocationEvent().id(1L).zoneConfidence(1).rssi(1).txPower(1).rawPayload("rawPayload1");
    }

    public static LocationEvent getLocationEventSample2() {
        return new LocationEvent().id(2L).zoneConfidence(2).rssi(2).txPower(2).rawPayload("rawPayload2");
    }
