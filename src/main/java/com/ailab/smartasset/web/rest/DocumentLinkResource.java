...
public class DocumentLinkResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<DocumentLinkDTO>> getAllDocumentLinks(
        DocumentLinkCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get DocumentLinks by criteria: {}", criteria);

        Page<DocumentLinkDTO> page = documentLinkQueryService.findByCriteria(criteria, pageable);
