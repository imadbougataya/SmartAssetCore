package com.ailab.smartasset.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ailab.smartasset.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ailab.smartasset.repository.UserRepository.USERS_BY_EMAIL_CACHE);
